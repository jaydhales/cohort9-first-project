...
const TodoItem = ({ todo }) => {
   ...
   return <li className={`todo  py-3 px-2 rounded-md shadow  shadow-gray-500 flex items-center gap-2 relative overflow-hidden ${!!completed ? "bg-green-700 bg-opacity-10" :"bg-white/20"}`}>
